...
import me.logg.printer.manager.PrinterManager;
...
public class Utils {
    ...
    private static String objectToString(Object object, int childLevel) {
        ...
        if (Utils.isArray(object)) {
            return Utils.parseArray(builder, object);
        }
        ...
        if (getArrayDimension(array) == 1) {
            switch (getType(array)) {
                ...
                case 'L':
                    ...
                    result.append(LoggConstant.SPACE).append(LoggConstant.BR).append("[");
     ...
     * @return
     */
    public static String parseArray(StringBuilder builder, Object array) {
        traverseArray(builder, array);
        return builder.toString();
    }
}